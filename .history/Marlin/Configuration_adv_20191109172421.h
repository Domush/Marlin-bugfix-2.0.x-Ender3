...
#define CONTROLLERFAN_SPEED 240        // 255 == full speed
#define CONTROLLERFAN_SPEED_Z_ONLY 140 // Reduce noise on machines that keep Z enabled
#endif
 ...
 */
// Extruder 0 fan is connected to HE 1 (only one extruder/hotend),
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 170
#define EXTRUDER_AUTO_FAN_SPEED 235 // 255 == full speed
#define CHAMBER_AUTO_FAN_TEMPERATURE 150
#define CHAMBER_AUTO_FAN_SPEED 235
...
/**
   ...
   *
   * Note: If the probe is not deploying, check a "Cmd: Reset" and "Cmd:
   *       Self-Test" and then check the wiring of the BROWN, RED and ORANGE
   *       wires.
   *
   * Note: If the trigger signal of your probe is not being recognized, it has
   *       been very often because the BLACK and WHITE wires needed to be
   *       swapped. They are not "interchangeable" like they would be with a
   *       real switch. So please check the wiring first.
   *
...
#define FILAMENT_CHANGE_UNLOAD_LENGTH 100    // (mm) The length of filament for a complete unload. For Bowden, the full length of the tube and nozzle. For direct drive, the full length of the nozzle. Set to 0 for manual unloading.
...
#define FILAMENT_CHANGE_FAST_LOAD_LENGTH 0   // (mm) Load length of filament, from extruder gear to nozzle. For Bowden, the full length of the tube and nozzle. For direct drive, the full length of the nozzle.
//#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
#define ADVANCED_PAUSE_PURGE_FEEDRATE 3 // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
#define ADVANCED_PAUSE_PURGE_LENGTH 50  // (mm) Length to extrude after loading. Set to 0 for manual extrusion. Filament can be extruded repeatedly from the Filament Change menu until extrusion is consistent, and to purge old filament.
...
#define INTERPOLATE 256     // Interpolate X/Y/Z_MICROSTEPS to 256
...
#define X_HYBRID_THRESHOLD 152 // [mm/s]
...
#define CUSTOM_USER_MENU_TITLE "Quick Actions"
...
#define USER_DESC_5 "Activate firmware update"
#define USER_GCODE_5 "M502\nM500\nM117 Update complete"
#endif
...
#define I2CPE_ENC_1_TYPE I2CPE_ENC_TYPE_LINEAR // Type of encoder:  I2CPE_ENC_TYPE_LINEAR -or- I2CPE_ENC_TYPE_ROTARY.
#define I2CPE_ENC_1_TICKS_UNIT 2048            // 1024 for magnetic strips with 2mm poles; 2048 for 1mm poles. For linear encoders this is ticks / mm, for rotary encoders this is ticks / revolution.
//#define I2CPE_ENC_1_TICKS_REV     (16 * 200)            // Only needed for rotary encoders; number of stepper steps per full revolution (motor steps/rev * microstepping)
//#define I2CPE_ENC_1_INVERT                              // Invert the direction of axis travel.
#define I2CPE_ENC_1_EC_METHOD I2CPE_ECM_MICROSTEP // Type of error error correction.
#define I2CPE_ENC_1_EC_THRESH 0.10                // Threshold size for error (in mm) above which the printer will attempt to correct the error; errors smaller than this are ignored to minimize effects of measurement noise / latency (filter).
...
#define MAX7219_ROTATE 0       // Rotate the display clockwise (in multiples of +/- 90°) connector at:  right=0   bottom=-90  top=90  left=180
...
#define MAX7219_DEBUG_PLANNER_QUEUE 0 // Show the current planner queue depth on this and the next LED matrix row If you experience stuttering, reboots, etc. this option can reveal how tweaks made to the configuration are affecting the printer in real-time.
#endif
