...
#define STRING_CONFIG_H_AUTHOR "(Edward, Ender-3 v64.1.0)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Edward's Ender 3" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "SKR v1.3 - TMC2130"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Ender 64-Step"
...
// Ender-3 has a PTFE tube in it, limit to 260 (so really to 245C) to avoid breaking
// the PTFE
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 defaults
  // #define DEFAULT_Kp 21.73
  // #define DEFAULT_Ki 1.54
  // #define DEFAULT_Kd 76.55

// Creality Ender-3 - Edward's Ender 3
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
  #define DEFAULT_bedKp 97.07
  #define DEFAULT_bedKi 12.76
  #define DEFAULT_bedKd 492.29
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100 }       // 16 step config
#define DEFAULT_AXIS_STEPS_PER_UNIT   { (80*4-3.2), (80*4-3.2), (400*4), (100*4) } // 64 step config
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { (80*8), (80*8), (400*8), (100*8) } // 128 step config
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { (80*16), (80*16), (400*16), (100*16) } // 256 step config
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 65, 90 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 900, 900, 400, 600 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.77   // Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 47

// X and Y axis travel speed (mm/m) between probes
// Keep it below the hybrid threshold to stay in stealthchop.
#define XY_PROBE_SPEED (X_HYBRID_THRESHOLD*60-10)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.23  // (mm) Default layer height for the G26 Mesh Validation Tool.
    ...
    #define G26_XY_FEEDRATE         35    // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool.
  #endif
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP  1.0  // (mm) Move nozzle up before moving between corners
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (X_HYBRID_THRESHOLD*60-5)
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_TRIANGLES  1

  // Specify positions as { X, Y, Z }
  #define NOZZLE_CLEAN_START_POINT { 10, 14, (Z_MIN_POS + .3)}
  #define NOZZLE_CLEAN_END_POINT   { 12, 100, (Z_MIN_POS + .3) }
