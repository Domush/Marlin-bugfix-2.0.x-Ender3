...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.745 // Z offset: -below +above  [the nozzle]
...
#define MESH_TEST_LAYER_HEIGHT 0.26 // (mm) Default layer height for the G26 Mesh Validation Tool.
