...
#define Z_SAFE_HOMING_X_POINT (X_PROBE_OFFSET_FROM_EXTRUDER * -1 + 2) // X point for Z homing when homing all axes (G28).
#define Z_SAFE_HOMING_Y_POINT (Y_PROBE_OFFSET_FROM_EXTRUDER * -1 + 2) // Y point for Z homing when homing all axes (G28).
#endif
